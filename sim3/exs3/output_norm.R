#############################################################################################
# This script corresponds to reproduce Ex S3 in Table S2 in the supplementary materials.
...
# -----------------------------------------------------------------------------
base_folder <- "~/glmcv/simuV2/result_norm/V2norm/"  
output_folder <- "~/glmcv/simuV2/result_norm/V2norm/" 
file_prefix <- "facnum-norm-cada"  
