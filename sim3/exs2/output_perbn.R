#############################################################################################
# This script corresponds to reproduce Ex S2 in Table S2 in the supplementary materials.
...
# -----------------------------------------------------------------------------
base_folder <- "~/glmcv/simuV2/result_poi/V2q4perbn/"  
output_folder <- "~/glmcv/simuV2/result_poi/V2q4perbn/" 
file_prefix <- "facnum-perbn-cada"  
