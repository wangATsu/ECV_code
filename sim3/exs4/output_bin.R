#############################################################################################
# This script corresponds to reproduce Ex S4 in Table S2 in the supplementary materials.
...
# -----------------------------------------------------------------------------
base_folder <- "~/glmcv/simuV2/result_bin/V2bin/"  
output_folder <- "~/glmcv/simuV2/result_bin/V2bin/" 
file_prefix <- "facnum-bin-cada-u8q2"  
xlsx_filename <- file.path(output_folder, "result_facnum_mat-u8q2.xlsx")
rds_filename <- file.path(output_folder, "result_facnum_mat-u8q2.rds")
