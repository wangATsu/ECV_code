#############################################################################################
# This script corresponds to Example 2 in the main text.
...
base_dir <- "~/glmcv/simuV2/result_poi/V2q4_othernp"
...
n_values <- c(30,50,500,1000)
p_values <- c(30,50,500,1000)
...
for (n in n_values) {
  for (p in p_values) {
    ...
    for (s in 1:n_simulations) {
      ...
      # Log progress
     # cat("Processing iteration:", s, "\n", file = file.path(base_dir, "debug_log.txt"), append = TRUE)
