#############################################################################################
# This script corresponds to reproduce Ex 6 in Table 1 in the main text.
...
# -----------------------------------------------------------------------------
base_folder <- "~/glmcv/simuV2/result_poi/V2overdis/"  
output_folder <- "~/glmcv/simuV2/result_poi/V2overdis/"
file_prefix <- "facnum-overdis1-10-cada" 
