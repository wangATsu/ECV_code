#############################################################################################
# This script corresponds to reproduce Ex 5 in Table 1 in the main text.
...
# -----------------------------------------------------------------------------
base_folder <- "~/glmcv/simuV2/result_poi/V2q4_miss/"  
output_folder <- "~/glmcv/simuV2/result_poi/V2q4_miss/" 
file_prefix <- "facnum-miss-cada"  
