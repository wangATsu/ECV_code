#############################################################################################
# This script corresponds to reproduce Ex 3 in Table 1 in the main text.
...
# -----------------------------------------------------------------------------
base_folder <- "~/glmcv/simuV2/result_poi/V2q4perbp/"  
output_folder <- "~/glmcv/simuV2/result_poi/V2q4perbp/" 
file_prefix <- "facnum-perbp-cada"  
